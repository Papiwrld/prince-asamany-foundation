      ...
      <div className="max-w-7xl mx-auto px-5 md:px-8">
        <div className="flex flex-col lg:flex-row items-center justify-center gap-x-10 gap-y-6">
          ...
          >
            ...
            <span>
              <span className="block font-body text-sm font-bold text-brand-navy group-hover:text-brand-red-dark transition-colors duration-200">
                Featured by Choice News Online
                <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" className="inline-block ml-1 -mt-0.5 transition-transform duration-200 group-hover:translate-x-0.5 group-hover:-translate-y-0.5">
